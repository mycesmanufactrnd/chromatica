    ...
    <div className="min-h-screen bg-background">
      <header className="sticky top-0 z-50 bg-background/80 backdrop-blur-xl border-b border-border/50">
        <div className="max-w-lg mx-auto px-4 h-14 flex items-center gap-3">
          <Link to="/" className="w-8 h-8 rounded-full flex items-center justify-center hover:bg-accent/10 hover:text-accent transition-colors">
      ...
      <main className="max-w-lg mx-auto px-4 py-8 space-y-6 text-sm text-foreground leading-relaxed">
        <p className="inline-block text-accent text-xs font-medium bg-accent/10 rounded-full px-3 py-1">Last updated: May 2026</p>

        <section className="space-y-2">
          <h2 className="font-semibold text-base flex items-center gap-2"><span className="w-1.5 h-1.5 rounded-full bg-accent" />1. Acceptance of Terms</h2>
        ...
        <section className="space-y-2">
          <h2 className="font-semibold text-base flex items-center gap-2"><span className="w-1.5 h-1.5 rounded-full bg-accent" />2. Use of the Service</h2>
          <p className="text-muted-foreground">
        ...
        <section className="space-y-2">
          <h2 className="font-semibold text-base flex items-center gap-2"><span className="w-1.5 h-1.5 rounded-full bg-accent" />3. Uploaded Content</h2>
          <p className="text-muted-foreground">
        ...
        <section className="space-y-2">
          <h2 className="font-semibold text-base flex items-center gap-2"><span className="w-1.5 h-1.5 rounded-full bg-accent" />4. Intellectual Property</h2>
          <p className="text-muted-foreground">
        ...
        <section className="space-y-2">
          <h2 className="font-semibold text-base flex items-center gap-2"><span className="w-1.5 h-1.5 rounded-full bg-accent" />5. Disclaimer of Warranties</h2>
          <p className="text-muted-foreground">
        ...
        <section className="space-y-2">
          <h2 className="font-semibold text-base flex items-center gap-2"><span className="w-1.5 h-1.5 rounded-full bg-accent" />6. Limitation of Liability</h2>
          <p className="text-muted-foreground">
        ...
        <section className="space-y-2">
          <h2 className="font-semibold text-base flex items-center gap-2"><span className="w-1.5 h-1.5 rounded-full bg-accent" />7. Changes to Terms</h2>
          <p className="text-muted-foreground">
        ...
        <section className="space-y-2">
          <h2 className="font-semibold text-base flex items-center gap-2"><span className="w-1.5 h-1.5 rounded-full bg-accent" />8. Contact</h2>
          <p className="text-muted-foreground">
